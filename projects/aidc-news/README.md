...
# AI Data Center 산업 동향 자동 수집·분석 시스템
...
> - 정부기관 4곳 + 공기업 4곳 + 지자체 + 국내외 기업 뉴스를 **완전 자동 수집·분석 파이프라인**으로 구축
...
- 데이터 수집 대상(정부기관 4곳, 공기업 4곳, 지자체, 국내외 기업)을 조사하고 수집 전략 설계
